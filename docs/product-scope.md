...
| Helper canonique `filter_products_by_scope` | ⏳ À implémenter par la première tâche consommatrice | Section 6 |
| Filtrage appliqué à `readiness`, `prioritization`, `weekly`, `next_best_actions`, `faq_generator` | ⏳ À porter par les tâches consommatrices 131-134 | Section 4 |
