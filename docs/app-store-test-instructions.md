# App Store Reviewer Test Instructions — GEO by Organically

> Audience: Shopify App Store review team
> Estimated test duration: 15–20 minutes
> Last updated: 2026-05-18

Thank you for reviewing **GEO by Organically**. This document walks you through every
...
2. Shopify shows the standard install screen listing scopes:
   ...
   Click **Install app**.
3. You are redirected into the embedded GEO by Organically **Dashboard** inside the
...
2. You see three plans:
   - **GEO by Organically Free** — $0 / month (active by default after install)
   - **GEO by Organically Pro** — $29 USD / 30 days
   - **GEO by Organically Agency** — $99 USD / 30 days
...
1. From Shopify Admin → Settings → Apps → **GEO by Organically** → click **Delete**.
