...
1. Use the `GEO by Organically` Shopify Partner app for the pilot.
...
```toml
application_url = "https://leonie-seo-pilot-web.onrender.com"

[auth]
redirect_urls = [
  "https://leonie-seo-pilot-web.onrender.com/auth/callback",
  "https://leonie-seo-pilot-web.onrender.com/auth/shopify/callback",
]
```
...
SHOPIFY_API_KEY=...
SHOPIFY_API_SECRET=...
SCOPES=read_products,write_products,write_content,read_themes,write_themes
SHOPIFY_APP_URL=https://leonie-seo-pilot-web.onrender.com
...
- `leonie-seo-pilot-web` — Remix embedded app, attached to `leonie-seo-pilot-web.onrender.com`;
...
6. Add and verify the custom domain `leonie-seo-pilot-web.onrender.com` on the web service.
...
- Public HTTPS origin `https://leonie-seo-pilot-web.onrender.com` is live and stable.
