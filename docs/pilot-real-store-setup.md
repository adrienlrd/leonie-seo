...
```toml
application_url = "https://pilot.leoniedelacroixfrance.com"

[auth]
redirect_urls = [
  "https://pilot.leoniedelacroixfrance.com/auth/callback",
  "https://pilot.leoniedelacroixfrance.com/auth/shopify/callback",
]
```
...
SHOPIFY_APP_URL=https://pilot.leoniedelacroixfrance.com
...
- `leonie-seo-pilot-web` — Remix embedded app, attached to `pilot.leoniedelacroixfrance.com`;
...
6. Add and verify the custom domain `pilot.leoniedelacroixfrance.com` on the web service.
...
- Public HTTPS origin `https://pilot.leoniedelacroixfrance.com` is live and stable.
