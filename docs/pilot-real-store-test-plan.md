...
|---|---|---|---|
| Install/session | Open the GEO by Organically app from Shopify Admin. Refresh once. Navigate away and back. | App loads embedded without OAuth loop; session persists. | Load time, any Shopify frame/session warning. |
