...
def test_detect_cannibal_pairs_detects_two_competing_pages():
    df = _make_df(
        [
            {
                "query": "fontaine chat",
                "url": "https://ex.com/products/fontaine",
                "clicks": 5,
                "impressions": 80,
                "ctr": 0.06,
                "position": 4.0,
            ...
            {
                "query": "fontaine chat",
                "url": "https://ex.com/collections/fontaines",
                "clicks": 2,
                "impressions": 40,
                "ctr": 0.05,
                "position": 7.0,
...
def test_detect_cannibal_pairs_sorted_by_severity_descending():
    df = _make_df(
        [
            ...
            {
                "query": "q2",
                "url": "https://ex.com/collections/d",
                "clicks": 0,
                "impressions": 12,
                "ctr": 0.00,
                "position": 25.0,
